  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={{ borderBottomColor: '#cccccc', borderBottomWidth: 1.5, marginTop: 10, marginBottom: 20 }}>
        ...
        <ScrollView>
          <View style={styles.inputView}>
            ...
            <TextInput style={styles.inputInfo} value = {email}
            editable = {false}>
          ...
          <View style={styles.inputView}>
            ...
            <TouchableOpacity onPress={() => this.setState({ countryVisible: true })}>
              <View style={{ ...styles.inputInfo, justifyContent: 'center' }} >
                <CountryPicker
                  {...{
          ...
          <View style={styles.inputView}>
            ...
            <View style={{ ...styles.inputInfo, justifyContent: 'center' }}>
              <TouchableOpacity onPress={() => this.setState({ isCalendarVisibleBirthday: true })}>
                <Moment
                  date={birthday}
                  format="DD/MM/YYYY"
                  element={Text}
          ...
          <View style={styles.inputView}>
            ...
            onChangeText = { value => this.setState({ personalID : value })}></TextInput>
          </View>
          ...
          <View style={styles.inputView}>
            ...
            <TextInput style={styles.inputInfo} value = {phoneNum}
          ...
          <View style={{ flexDirection: 'row' , height : 50 , marginVertical : 10}}>
            <View style = {{...styles.btnButton, backgroundColor : '#26B2D5' ,width :'47%', marginRight : 10 }}>
              <TouchableOpacity onPress = {this.handleSubmit}>
                <Text style = {{...styles.txtButton, color : '#ffffff'}}>
                  Confirm
                </Text>
              </TouchableOpacity>
            </View>
            <View style = {{...styles.btnButton,borderWidth : 0.5 , backgroundColor : '#ffffff' , flex : 1}}>
              <TouchableOpacity>
