import { Text, View, StyleSheet, FlatList, Dimensions, ScrollView, BackHandler } from 'react-native';
...
class CartScreen extends React.Component {
  ...
  itemSeparatorComponent = () => {
    return (
      <View style={{ height: 10, borderBottomWidth: 0.5, borderBottomColor: '#bbbbbb' }}></View>
    )
  }
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={{ marginTop: 10, flexDirection: 'row' }}>
          ...
          <Text style={{ fontSize: 16 }}> {' '}{this.handleTotal().toString()}USD</Text>
        </View>
        ...
        <View style={{ alignItems: 'center', justifyContent: 'center', flex: 1 }}>
          ...
          <TouchableOpacity style={{ ...styles.btnCheckout, backgroundColor: '#e6f3ff' }} onPress = {this.handleContinueShopping}>
...
const styles = new StyleSheet.create({
  ...
  btnCheckout: {
    width: Dimensions.get('window').width - 80, height: 45,
    borderRadius: 20, justifyContent: 'center', marginVertical: 5
  }
})